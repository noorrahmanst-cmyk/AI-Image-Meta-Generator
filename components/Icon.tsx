...
const ICONS: Record<string, JSX.Element> = {
    ...
    sparkles: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L15 10.414m-4.293 2.293a1 1 0 01-1.414 0L5 8.293m7.707 7.707a1 1 0 010 1.414L10.414 20m2.293-4.293a1 1 0 011.414 0L17 18.121" />,
    ...
    uploadCloud: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />,
    fileText: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 4H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V8m-6-4v4m0 0h4m-4 0L7 4" />,
    vector: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8V4h4m10 4V4h-4M3 16v4h4m10-4v4h-4m-7-4h4v4h-4v-4z" />,
